# Generated by Django 5.0.6 on 2024-06-04 08:35
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='extrainfo',
            name='gatunek',
            field=models.PositiveSmallIntegerField(blank=True, choices=[(3, 'Sci-fi'), (0, 'Inne'), (1, 'Horror'), (2, 'Komedia'), (4, 'Dramat')], null=True),
        ),
    ]
